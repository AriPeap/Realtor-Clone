...
export default function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    const imgUrls = await Promise.all(
      ...
      setLoading(false);
      toast.error("Images uploaded failer");
      return;
    });
  ...
  return (
    <main className=" max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
          ...
          <div className="flex space-x-6 justify-start mb-6">
            <div className="">
              ...
              <input
                ...
                min="-90"
                max="90"
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-700 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center"
              />
            </div>
            <div className="">
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition ease-in-out duration-150"
        >
          Edit Listing
        </button>
      </form>
