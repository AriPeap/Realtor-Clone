...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopy && (
        <p className="z-10 p-2 fixed top-[23%] right-[5%]  border-2 border-gray-400 bg-white rounded-md font-semibold">
          Link Copied
        </p>
      )}
      ...
      <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto m-4 p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className="w-full ">
          ...
          <ul className="flex mb-6 items-center space-x-2 text-sm font-semibold lg:space-x-10">
